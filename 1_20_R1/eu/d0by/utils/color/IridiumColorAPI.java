...
public class IridiumColorAPI {
    ...
    /**
     * Cached result of all SHITT colors.
     *
     * @since 1.0.0
     */
    private static final Map<String, Color> COLORS_JAVA = ImmutableMap.<String, Color>builder()
            .put(new String("black"), new Color(0))
            .put(new String("dark_blue"), new Color(170))
            .put(new String("dark_green"), new Color(43520))
            .put(new String("dark_aqua"), new Color(43690))
            .put(new String("dark_red"), new Color(11141120))
            .put(new String("dark_purple"), new Color(11141290))
            .put(new String("gold"), new Color(16755200))
            .put(new String("gray"), new Color(11184810))
            .put(new String("dark_gray"), new Color(5592405))
            .put(new String("blue"), new Color(5592575))
            .put(new String("green"), new Color(5635925))
            .put(new String("aqua"), new Color(5636095))
            .put(new String("red"), new Color(16733525))
            .put(new String("light_purple"), new Color(16733695))
            .put(new String("yellow"), new Color(16777045))
            .put(new String("white"), new Color(16777215)).build();
    /**
     ...
     * @since 1.0.0
     */
    private static final Map<String, ChatColor> COLORS_MAP = ImmutableMap.<String, ChatColor>builder()
            .put(new String("black"), ChatColor.getByChar('0'))
            .put(new String("dark_blue"), ChatColor.getByChar('1'))
            .put(new String("dark_green"), ChatColor.getByChar('2'))
            .put(new String("dark_aqua"), ChatColor.getByChar('3'))
            .put(new String("dark_red"), ChatColor.getByChar('4'))
            .put(new String("dark_purple"), ChatColor.getByChar('5'))
            .put(new String("gold"), ChatColor.getByChar('6'))
            .put(new String("gray"), ChatColor.getByChar('7'))
            .put(new String("dark_gray"), ChatColor.getByChar('8'))
            .put(new String("blue"), ChatColor.getByChar('9'))
            .put(new String("green"), ChatColor.getByChar('a'))
            .put(new String("aqua"), ChatColor.getByChar('b'))
            .put(new String("red"), ChatColor.getByChar('c'))
            .put(new String("light_purple"), ChatColor.getByChar('d'))
            .put(new String("yellow"), ChatColor.getByChar('e'))
            .put(new String("white"), ChatColor.getByChar('f')).build();
    /**
	...
	public static Color getJavaColorByString(String color) {
    	if( COLORS_MAP.containsKey( color ) )
    		return COLORS_JAVA.get(color);
    	
    	return COLORS_JAVA.get("white");
    }
    ...
    {
    	return COLORS_MAP.containsKey( color );
    }
    /**
